...
export default class Notification extends React.Component {
  render() {
    ...
    const iconContainer = [
      ...
      { backgroundColor: color || yummlyTheme.COLORS.PRIMARY },
    ...
    const container = [
      styles.card,
      !transparent && { backgroundColor: yummlyTheme.COLORS.WHITE },
            ...
            <Block top flex={system ? 0.12 : 0.2} middle>
              <Block middle style={iconContainer}>
                <Icon
                  ...
                  color={
                    iconColor || system ? yummlyTheme.COLORS.DEFAULT : yummlyTheme.COLORS.WHITE
                  }
                />
              </Block>
            </Block>
            <Block flex style={{ paddingRight: 3, paddingLeft: 12 }}>
              {system && (
                <Block row space="between" style={{ height: 18 }}>
                  <Text color={yummlyTheme.COLORS.MUTED} style={{ fontFamily: 'open-sans-bold' }} size={13}>{title}</Text>
