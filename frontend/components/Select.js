    ...
    return (
      <ModalDropdown
        ...
        <Block flex row middle space="between">
          ...
          <Icon name={iconName || "nav-down"} family={iconFamily || "YummlyExtra"} size={iconSize || 10} color={iconColor || yummlyTheme.COLORS.WHITE} />
        </Block>
      </ModalDropdown>
    )
  }
...
const styles = StyleSheet.create({
  qty: {
    width: 100,
    backgroundColor: yummlyTheme.COLORS.DEFAULT,
